...
class Game:
    ...
    def __init__(self):
        ...
        # Add 3 canons, same X, Y offseted in a structured wave pattern (0, 30, 60 frames)
        self.canons.add(Canon(900, 560, initial_cooldown=0))
        self.canons.add(Canon(900, 399, initial_cooldown=30))
        self.canons.add(Canon(900, 480, initial_cooldown=60))
        self.pressed = {}
